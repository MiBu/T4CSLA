...
namespace CslaExtension.Designer
{
	...
	[EntityDesignerExtendedProperty(EntityDesignerSelection.ConceptualModelNavigationProperty)]
	class CslaNavigationExtensionFactory : IEntityDesignerExtendedProperty
	{
		/// <summary>
		...
		{
			return new CslaNavigationExtension(element, context);
		}
	}
}